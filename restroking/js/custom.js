...
document.getElementById("add").addEventListener("click", () => {
	...
	let price = Math.floor(Math.random() * 100); // random price
	...
	// quantity select  
	cell3.innerHTML = `
	  <input type="number" value="1" class="form-control qty" min="1"> 
	`;
